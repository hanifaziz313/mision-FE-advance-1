  ...
  "+20": {
    ...
    svg: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="9" width="6" height="24" fill="#000" />
        <path d="M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z" fill="#C09300" />
      </svg>
    ),
    name: "Egypt",
  },
  "+90": {
    ...
    svg: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M12 15.5C13.933 15.5 15.5 13.933 15.5 12C15.5 10.067 13.933 8.5 12 8.5C10.067 8.5 8.5 10.067 8.5 12C8.5 13.933 10.067 15.5 12 15.5Z" fill="#E30A17" />
        <path d="M12 14L9 12L12 10L15 12L12 14Z" fill="white" />
        <path d="M12 13L10 12L12 11L14 12L12 13Z" fill="#E30A17" />
      </svg>
    ),
    name: "Turkey",
  },
  ...
  "+65": {
    ...
    svg: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M5 8L4 9L5 10L7 9L5 8Z" fill="white" />
        <path d="M9 5L8 7L9 8L11 7L9 5Z" fill="white" />
        <path d="M9 11L8 12L9 13L11 12L9 11Z" fill="white" />
        <path d="M5 14L4 15L5 16L7 15L5 14Z" fill="white" />
      </svg>
    ),
    name: "Singapore",
  },
    ...
    <div className="min-h-screen bg-[#FCF8CA] flex flex-col">
      ...
      <div className="flex-grow flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-white shadow-lg rounded-lg overflow-hidden">
          <div className="p-6">
            <h3 className="text-center text-xl font-bold text-black">Pendaftaran Akun</h3>
            <p className="text-center text-[#333333AD] py-2">Yuk, daftarkan akunmu sekarang juga!</p>

            <form className="text-[#333333AD]" onSubmit={handleSubmit}>
              {/* Name Input */}
              <div className="mb-4">
                <label htmlFor="name" className="block text-sm font-medium mb-1">
                  Nama Lengkap
                </label>
                <input type="text" id="name" name="name" value={formData.name} onChange={handleChange} className="w-full p-2 border rounded text-black" placeholder="Masukan Nama" required />
              </div>
              {/* Email Input */}
              <div className="mb-4">
                ...
                <input type="email" id="email" name="email" value={formData.email} onChange={handleChange} className="w-full p-2 border rounded" placeholder="Masukkan email" required />
              </div>
              {/* Phone Number Input */}
              <div className="mb-4">
                ...
                <div className="flex items-center">
                  <div className="mr-2">{countryFlags[countryCode]?.svg || countryFlags["+62"].svg}</div>
                  <select value={countryCode} onChange={handleCountryChange} className="p-2 border rounded w-24">
                  ...
                  <input type="tel" id="phone" name="phone" value={formData.phone} onChange={handleChange} className="ml-2 flex-grow p-2 border rounded" placeholder="Nomor Telepon" />
                </div>
              </div>
              {/* Password Input */}
              {/* Password Input */}
              <div className="mb-4">
                ...
                <div className="relative">
                  <input type={showPassword ? "text" : "password"} id="password" name="password" value={formData.password} onChange={handleChange} className="w-full p-2 border rounded pr-10" required />
                  <button type="button" onClick={togglePassword} className="absolute right-2 top-2 text-gray-500 flex items-center">
                    {showPassword ? (
                      <>
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  <input type={showConfirmPassword ? "text" : "password"} id="confirmPassword" name="confirmPassword" value={formData.confirmPassword} onChange={handleChange} className="w-full p-2 border rounded pr-10" required />
                  <button type="button" onClick={toggleConfirmPassword} className="absolute right-2 top-2 text-gray-500 flex items-center">
                    {showConfirmPassword ? (
                      <>
                        <FaEyeSlash className="mr-1" />
                      </>
              ...
              <div className="space-y-3">
                ...
                <button type="button" className="w-full bg-white text-green-600 py-2 border border-green-600 rounded hover:bg-gray-100">
                  Masuk
                </button>
                ...
                <div className="relative my-4">
                  ...
                  <div className="relative flex justify-center">
                    <span className="px-2 bg-white text-gray-500 text-sm">Atau</span>
                  </div>
                </div>

                <button type="button" className="w-full bg-white text-gray-700 py-2 border border-gray-300 rounded flex items-center justify-center hover:bg-gray-50">
